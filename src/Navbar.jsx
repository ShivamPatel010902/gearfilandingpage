            ...
            <nav className=" bg-gray-200 border-gray-200 py-2.5">
                <div className="flex items-center justify-between max-w-screen-xl px-4 py-3 mx-auto">
                    <div>
                        ...
                        <ul className={openmenu ? "lg:flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0 hidden" : "lg:flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0"} >
                            <li>
